    ...
    'app.comp.container $ %{} 'FileEntry
      :defs $ {}
        'at-pattern $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def at-pattern (new js/RegExp |@)
          :examples $ []
          :schema $ :: 'Dynamic
            ...
            div
              ...
              comp-icon :trash
                ...
                fn (e d!) (d! :clear nil)
                  let
                      nodes $ unsafe-coerce
                        js/document.querySelectorAll |audio
                        , 'JsObject
        ...
        'reading-list $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def reading-list
            []
              ...
              tagging-edn $ to-calcit-data $ toml/parse
                slurp |data/2020-08-12-template-stringify.toml
        ...
        'speech! $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn speech! (text cb)
            let
                t $ unsafe-coerce
                  new js/window.SpeechSynthesisUtterance text
                  , 'JsObject
              set! (.-lang t) |zh-cn
              set! (.-rate t) 1.2
              let
                  voices $ unsafe-coerce
        ...
        'url-pattern $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def url-pattern
            new js/RegExp |https?:[\w\d\/_#\.\=\?\-\%]+
          :examples $ []
          :schema $ :: 'Dynamic
      :ns $ %{} 'NsEntry (:doc |)
